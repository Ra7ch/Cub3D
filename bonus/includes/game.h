...
/*   Updated: 2023/11/18 00:41:17 by raitmous         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define FLINUX 102
# define KNIFELINUX 65436
# define DOOMLINUX 65433
# define ATTACKLINUX 65435
# define UNARMEDLINUX 65438
# define ESCLINUX 65307
# define WMAC 13
# define SMAC 1
# define AMAC 0
# define DMAC 2
...
void			renderMap(t_game *game);
int				mouse_press(int button, int x, int y, t_game *data);
